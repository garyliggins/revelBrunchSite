...
function cssmin() {
  ...
  .pipe(cleanCSS())
  .pipe(dest('dist/source-files/allurio-css-min-files/'))
}
...
function cssexp() {
  ...
  .pipe(dest('dist/source-files/allurio-css-files/'))
}
...
function libs() {
  return src([
    ...
    'assets/Lettering.js-master/jquery.lettering.js',
...
function libsexp() {
  ...
  .pipe(concat('libs.js'))
  .pipe(dest('dist/source-files/allurio-js-files/'))
}
